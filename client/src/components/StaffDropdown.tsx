...
export default function StaffDropdown() {
  ...
  return (
    <div className="relative inline-block text-left text-gray-800 dark:text-white" ref={dropdownRef}>
      <button
        onClick={() => setIsOpen((prev) => !prev)}
        className="inline-flex items-center px-2 py-2 font-semibold rounded-md hover:bg-green-100 hover:text-green-600 dark:bg-gray-700 dark:hover:text-green-400 transition"
      >
        Staff
        <svg
