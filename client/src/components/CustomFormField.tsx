    ...
    switch (type) {
      ...
      case "select":
        return (
          ...
          >
            <SelectTrigger
              className={`w-full border-none bg-slate-900 dark:bg-slate-800 p-4 ${inputClassName}`}
            >
              <SelectValue placeholder={placeholder} />
            </SelectTrigger>
            <SelectContent className="w-full bg-slate-900 dark:bg-slate-800 border-customgreys-dirtyGrey shadow">
              {options?.map((option) => (
                <SelectItem
                  key={option.value}
                  value={option.value}
      ...
      default:
        return (
          <Input
            ...
            placeholder={placeholder}
            {...field}
            className={`border-none bg-slate-900 dark:bg-slate-800 p-4 ${inputClassName}`}
            disabled={disabled}
          />
        );
    }
