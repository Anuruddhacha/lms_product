...
export default function Page() {
  ...
  return (
    <>
      ...
      <section
        id="staff"
        className="pt-10 flex flex-col min-h-screen w-full bg-gradient-to-br from-blue-50 to-indigo-100 shadow-xl overflow-hidden"
      >
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-5xl font-extrabold text-gray-800 dark:text-white mb-4">
                Meet Our <span className="text-green-500 dark:text-green-500">Non-Academic Instructors</span>
              </h2>
