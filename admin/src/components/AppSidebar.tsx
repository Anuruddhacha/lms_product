...
const AppSidebar = () => {
  ...
  const navLinks = {
    ...
    teacher: [
      ...
      { icon: List, label: "Applications", href: "/teacher/studentsapplications" },
      { icon: Lock, label: "Passcodes", href: "/teacher/passcodes" },
      { icon: List, label: "Banners", href: "/teacher/banners" },
      { icon: List, label: "Events", href: "/teacher/events" },
      { icon: List, label: "Feedbacks", href: "/teacher/feedbacks" },
      { icon: List, label: "Gallery", href: "/teacher/gallery" },
      { icon: List, label: "Notices", href: "/teacher/notices" },
